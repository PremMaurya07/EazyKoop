<%@ Page Title="" Language="C#" MasterPageFile="~/Seller/ProductManagement/Site1.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="e_Koop.web.Seller.ProductManagement.Dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ks-header">
                <section class="ks-title-and-subtitle">
                    ...
                    <button class="btn btn-primary-outline ks-light ks-tabbed-sidebar-navigation-block-toggle" data-block-toggle=".ks-dashboard-tabbed-sidebar-sidebar">Tabs Panel</button>
                </section>
            </div>
                                                ...
                                                <div class="ks-tabbed-sidebar-activity-items ks-scrollable" data-auto-height>
                                                    <div class="ks-tabbed-sidebar-activity-item ks-activity-item-status-active">
                                                        <div class="ks-action-wrapper">
                                                            <img src="/img/avatar-6.jpg" alt="" class="ks-avatar rounded-circle" width="25" height="25">
                                                    ...
                                                    <div class="ks-tabbed-sidebar-activity-item ks-activity-item-status-active">
                                                        <div class="ks-action-wrapper">
                                                            <img src="/img/avatar-11.jpg" alt="" class="ks-avatar rounded-circle" width="25" height="25">
                                                            <a href="#" class="ks-action-message">Hi, What you think about new deal</a>
                                                        </div>
                                                    ...
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                        <div class="ks-action-wrapper">
                                                            <img src="/img/avatar-5.jpg" alt="" class="ks-avatar rounded-circle" width="25" height="25">
                                                            <a href="#" class="ks-action-message">Hi, What you think about new deal</a>
                                                        </div>
                                                    </div>
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                    ...
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                        <div class="ks-action-wrapper">
                                                            <img src="/img/avatar-2.jpg" alt="" class="ks-avatar rounded-circle" width="25" height="25">
                                                    ...
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                        <div class="ks-action-wrapper">
                                                            <img src="/img/avatar-3.jpg" alt="" class="ks-avatar rounded-circle" width="25" height="25">
                                                            <a href="#" class="ks-action-message">Hi Konstantin, Sent you quarter report</a>
                                                        </div>
                                                    </div>
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                    ...
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                        <div class="ks-action-wrapper">
                                                            <img src="/img/avatar-8.jpg" alt="" class="ks-avatar rounded-circle" width="25" height="25">
                                                            <a href="#" class="ks-action-message">Hi Konstantin, Sent you quarter report</a>
                                                        </div>
                                                    </div>
                                                    <div class="ks-tabbed-sidebar-activity-item">
                                                ...
                                                <div class="ks-tabbed-sidebar-comment-items ks-scrollable" data-auto-height>
                                                    <div class="ks-tabbed-sidebar-comment-item">
                                                        <div class="ks-tabbed-sidebar-comment-action">
                                                            <img src="/img/avatar-3.jpg" class="ks-avatar" width="25" height="25">
                                                            <div class="ks-action">
                                                    ...
                                                    <div class="ks-tabbed-sidebar-comment-item">
                                                        <div class="ks-tabbed-sidebar-comment-action">
                                                            <img src="/img/avatar-4.jpg" class="ks-avatar" width="25" height="25">
                                                            <div class="ks-action">
                                                    ...
                                                    <div class="ks-tabbed-sidebar-comment-item">
                                                        <div class="ks-tabbed-sidebar-comment-action">
                                                            <img src="/img/avatar-10.jpg" class="ks-avatar" width="25" height="25">
                                                            <div class="ks-action">
                                            ...
                                            <div class="ks-tabbed-sidebar-posts">
                                                ...
                                                <div class="ks-tabbed-sidebar-post-items ks-scrollable" data-auto-height>
                                                    <a href="#" class="ks-tabbed-sidebar-post-item">
                                                        <img src="/img/ph-1.png" alt="" class="ks-thumb" width="36" height="36">
                                                    ...
                                                    <a href="#" class="ks-tabbed-sidebar-post-item">
                                                        <img src="/img/ph-2.png" alt="" class="ks-thumb" width="36" height="36">
                                                        <span href="#" class="ks-description">
                                                            <span class="ks-name">Road trip essentials</span>
                                                            <span class="ks-extra-info">
                                                                <span class="ks-amount-block">1200 views</span>
                                                    ...
                                                    <a href="#" class="ks-tabbed-sidebar-post-item">
                                                        <img src="/img/ph-3.png" alt="" class="ks-thumb" width="36" height="36">
                                                        <span href="#" class="ks-description">
                                                            <span class="ks-name">Road trip essentials</span>
                                                            <span class="ks-extra-info">
                                                                <span class="ks-amount-block">1200 views</span>
                                                    ...
                                                    <a href="#" class="ks-tabbed-sidebar-post-item">
                                                        <img src="/img/ph-4.png" alt="" class="ks-thumb" width="36" height="36">
                                                        <span href="#" class="ks-description">
                                                            <span class="ks-name">Road trip essentials</span>
                                                            <span class="ks-extra-info">
                                                                <span class="ks-amount-block">1200 views</span>
                                                    ...
                                                    <a href="#" class="ks-tabbed-sidebar-post-item">
                                                        <img src="/img/ph-5.png" alt="" class="ks-thumb" width="36" height="36">
                                                        <span href="#" class="ks-description">
                                                            <span class="ks-name">Road trip essentials</span>
                                                            <span class="ks-extra-info">
                                                                <span class="ks-amount-block">1200 views</span>
                                        ...
                                        <div class="tab-pane-content">
                                            <div class="ks-tabbed-sidebar-favourites">
                                                ...
                                                <div class="ks-tabbed-sidebar-favourites-items ks-scrollable" data-auto-height>
                                                    ...
                                                    <a href="#" class="ks-tabbed-sidebar-favourite-item">
                                                        <img src="/img/avatar-7.jpg" alt="" class="ks-avatar" width="36" height="36">
                                                        <span href="#" class="ks-description">
